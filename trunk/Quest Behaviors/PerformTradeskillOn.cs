...
namespace Honorbuddy.Quest_Behaviors.PerformTradeskillOn
{
    ...
    class PerformTradeskillOn : CustomForcedBehavior
    {
        ...
        public override string SubversionId { get { return ("$Id: PerformTradeskillOn.cs 369 2013-03-18 09:05:58Z thebrodieman $"); } }
        public override string SubversionRevision { get { return ("$Revision: 369 hack $"); } }
        ...
        private int GetTradeSkillIndex()
        {
                ...
                for (int i = 1; i <= count; i++)
                {
					...
					string linka = Lua.GetReturnVal<string>("return GetTradeSkillItemLink(" + i + ")", 0);
                    ...
                    LogMessage("debug", "ID: " + id + " at " + i + " - " + linka);
